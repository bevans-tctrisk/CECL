...
def reports(short_name: str):
    ...
    selected: list[str] = []
    for r in ("tct", "vizo", "vizo_supp", "mgmt_adj_napkin", "acl_funding", "vizo_pdf", "vizo_supp_pdf"):
    ...
    if not _skip_stage:
        ...
        if unmapped:
            report_selection = {
                ...
                for r in ("tct", "vizo", "vizo_supp", "impdet", "mgmt_adj_napkin", "acl_funding", "vizo_pdf", "vizo_supp_pdf")
            }
            return render_template(
                "run/new_quarter.html",
                short_name=short_name,
